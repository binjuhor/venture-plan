...
const InsightScrollMenu = ({ translate }) => {
        ...
        <div className="container">
          <div className="scroll-menu__inner">
            <ul className="scroll-menu__nav">
              <li className="active"><AnchorLink href="#our-latest-insights">{translate("t.our_latest_insights")}</AnchorLink></li>
...
export default withLocalize(InsightScrollMenu)
